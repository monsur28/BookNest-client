    ...
    <div className="">
      <div className="bg-Community bg-cover bg-no-repeat py-20 px-5 rounded-lg">
        <div className="flex flex-col justify-center items-center">
          ...
          <div>
            <div className="flex rounded-3xl my-2 overflow-hidden max-w-md mx-auto">
              <input
                type="email"
              ...
              <button
                type="btn"
                className="flex items-center justify-center bg-orange-500 px-5 text-sm font-semibold text-white"
              >
                Subscribe
              </button>
            </div>
